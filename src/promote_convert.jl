...
FastRational{I1}(q::Rational{I2}; tol=eps(q)/2) where {I1<:Integer, I2<:Integer} = FastRational{I1}(rationalize(q.num/q.den,tol=tol))
FastRational{I1}(num::I2, den::I2) where {I1<:I2<:Integer} = FastRational{I1}(I1(num), I1(den))
