...
round(x::FastRational{T}, ::RoundingMode{:RoundUp}) where {T<:FastInt} = ceil(T, x)
round(x::FastRational{T}, ::RoundingMode{:RoundDown}) where {T<:FastInt} = floor(T, x)
round(x::FastRational{T}, ::RoundingMode{:RoundNearest}) where {T<:FastInt} = round(T, x.num/x.den, RoundNearest)
...
round(::Type{I}, x::FastRational{T}, ::RoundingMode{:RoundUp}) where {I<:Integer, T<:FastInt} = I(numerator(round(x, RoundUp)))
round(::Type{I}, x::FastRational{T}, ::RoundingMode{:RoundDown}) where {I<:Integer, T<:FastInt} = I(numerator(round(x, RoundDown)))
round(::Type{I}, x::FastRational{T}, ::RoundingMode{:RoundNearest}) where {I<:Integer, T<:FastInt} = I(numerator(round(x, RoundNearest)))
...
round(::Type{Integer}, x::FastRational{T}, ::RoundingMode{:RoundUp}) where {T<:FastInt} = round(T, x, RoundUp)
round(::Type{Integer}, x::FastRational{T}, ::RoundingMode{:RoundDown}) where {T<:FastInt} = round(T, x, RoundDown)
round(::Type{Integer}, x::FastRational{T}, ::RoundingMode{:RoundNearest}) where {T<:FastInt} = round(T, x, RoundNearest)
