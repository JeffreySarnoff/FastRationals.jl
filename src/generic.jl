...
FastQ32(x::Rational{T}) where {T<:Union{Int8, Int16, Int32}} = FastQ32(x.num%Int32, x.den%Int32)
FastQ32(x::Rational{T}) where {T<:Union{Int64, Int128}} = FastQ32(Int32(x.num), Int32(x.den))
FastQ64(x::Rational{T}) where {T<:Union{Int8, Int16, Int32, Int64}} = FastQ64(x.num%Int64, x.den%Int64)
FastQ64(x::Rational{T}) where {T<:Int128} = FastQ64(Int64(x.num), Int64(x.den))
FastQ128(x::Rational{T}) where {T<:SUN} = FastQ128(Int128(x.num), Int128(x.den))
